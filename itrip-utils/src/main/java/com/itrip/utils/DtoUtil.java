...
public class DtoUtil {
    ...
    private static final String DTO_FLAG_FAIL="fail";
    ...
    public  static Dto returnUserLinkFail(String msg){
        Dto dto=new Dto();
        dto.setSuccess(DtoUtil.DTO_FLAG_FAIL);
        dto.setErrorCode(ErrorCodeConstant.ERROR_CODE_UserLink_ERROR);
        dto.setMsg(msg);
        return  dto;
    }
